...
const supabaseUrl = "bsbcedwcugqyposauepc.supabase.co";
const supabaseKey = "sb_publishable_bqp6dLNfk5va_FAiarC-vw_e9pahy06"; // Clave pública (publishable key) para operaciones de lectura/escritura seguras desde el cliente
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (countriesGrid) {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            const match1 = { ecu: document.getElementById('score-ecu-m1').value, rival: document.getElementById('score-rival-m1').value };
            const match2 = { ecu: document.getElementById('score-ecu-m2').value, rival: document.getElementById('score-rival-m2').value };
            const match3 = { ecu: document.getElementById('score-ecu-m3').value, rival: document.getElementById('score-rival-m3').value };

            const prediction = {
                user_name: userName,
                champion: champion,
                scores: { m1: match1, m2: match2, m3: match3 },
                date: new Date().toLocaleDateString('es-EC', { hour: '2-digit', minute: '2-digit' })
            };
    ...
    function openModal(name) {
        ...
        document.getElementById('modal-iframe').src = specialVideos[name].video;
    ...
    async function renderTable() {
        ...
        quinielas.forEach((item) => {
            ...
            const s = item.scores || { m1: {ecu:0, rival:0}, m2: {ecu:0, rival:0}, m3: {ecu:0, rival:0} };
                ...
                <td>
                    <div class="table-matches-column">
                        ...
                        <div class="table-mini-match">
                            <img src="https://flagcdn.com/w20/ec.png" alt="ECU">
                            <span>ECU</span>
                            <span class="score-badge">${s.m2.ecu}</span>
                            <span>-</span>
                            <span class="score-badge">${s.m2.rival}</span>
                            <span>CIV</span>
                            <img src="https://flagcdn.com/w20/ci.png" alt="CIV">
                        </div>
                        <div class="table-mini-match">
                            <img src="https://flagcdn.com/w20/ec.png" alt="ECU">
                            <span>ECU</span>
